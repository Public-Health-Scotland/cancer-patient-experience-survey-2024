...
question_lookup <- question_mapping %>%
  select(question,question_type,question_text,response_option,response_text,response_text_dashboard,topic,cancercentreallocation,weighted,pnn,
         `2018_question`,`2018_option`,comparability_2018,`2015_question`,`2015_option`,comparability_2015,question_text_dashboard) %>%
